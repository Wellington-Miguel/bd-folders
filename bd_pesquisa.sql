...
CREATE INDEX idx_equipamento_disponibilidade ON TB_EQUIPAMENTO(ST_DISPONIBILIDADE)$$
CREATE INDEX idx_publicacao_area ON TB_PUBLICACAO(DS_AREA_CONHECIMENTO)$$
CREATE INDEX idx_avaliacao_nota ON TB_AVALIACAO(VL_NOTA)$$
CREATE INDEX idx_equipamento_laboratorio ON TB_EQUIPAMENTO(ID_LABORATORIO)$$
